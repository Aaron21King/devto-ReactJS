  ...
  return (
    <div className="container">
      <div className="greet">
        ...
        <p>
          {" "}
          <a href="https://dev.to/">DEV Community </a> is a community of 870,143
          amazing developers{" "}
        </p>
      </div>
      <div className="botones">
        <button className="btn-apple">  Continue with Apple </button>
        <button className="btn-forem">
          {" "}
          <img
            src="https://account.forem.com/assets/smiley-8750f55ac3131b76c24bab0d8a76c0ca4384a76efa121519b8c3164ba34a8e53.png"
            alt="Trulli"
            width="20"
            height="20"
          ></img>{" "}
